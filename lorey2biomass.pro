...
;		169: agb_array[*] = 3.1429 * (lorey_array^1.2)  ; from 250m against cms agb at pixel level
		169: agb_array[*] = 4.2158 * (lorey_array^1.05)  ; from 250m against cms agb at pixel level
; 170		- IW mixed
...
;		172: agb_array[*] = 0.3 * (lorey_array^2.05)  ; from 250m against cms agb at pixel level
		172: agb_array[*] = 2.8295* (lorey_array^1.3)  ; from 250m against cms agb at pixel level
;	173		- PA mixed
